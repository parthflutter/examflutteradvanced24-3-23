...
//
//     final covidModal = covidModalFromJson(jsonString);

import 'dart:convert';

CovidModal covidModalFromJson(String str) => CovidModal.fromJson(json.decode(str));

String covidModalToJson(CovidModal data) => json.encode(data.toJson());
...
class CovidModal {
  ...
  factory CovidModal.fromJson(Map<String, dynamic> json) => CovidModal(
